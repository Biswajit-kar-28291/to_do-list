    ...
    if request.method=="POST":
        ...
        if this_user:
            if password==this_user.password:
                ...
                return render_template('not_found.html',msg="incorrect password.")
        else:
            return render_template('not_found.html',msg="user not found.")
    ...
    if request.method=="POST":
        ...
        if this_user:
            ...
            if password==a_password:
                ...
                return render_template('not_found.html',msg="paswrod not matched. please try again")
